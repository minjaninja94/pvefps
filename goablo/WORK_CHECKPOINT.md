...
2. 거미어미고아의 거미줄 경고 영역과 45% 이하 강화 패턴을 실제 조작으로 밸런스 조정한다.
3. 브라우저 테스트를 GitHub Actions에서 실행해 원격 커밋마다 회귀 여부를 확인한다.
4. 각 작업 단위에 테스트, 재개 기록 갱신, 커밋 및 GitHub 원격 확인을 계속 수행한다.
