...
- 최신 구현/테스트 커밋: 1f3ad451ee313c1c6072ef45c54cd9d4dcdb71cf
...
1. queue 순서대로 Act 2 일반 몬스터 스프라이트 제작 또는 제공 여부를 확인하고, 준비된 자산만 작은 단위로 통합한다.
2. 브라우저 테스트를 GitHub Actions에서 실행해 원격 커밋마다 회귀 여부를 확인한다.
3. 각 작업 단위에 테스트, 재개 기록 갱신, 커밋 및 GitHub 원격 확인을 계속 수행한다.
